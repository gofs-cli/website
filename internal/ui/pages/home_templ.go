...
func Home() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = Github("https://github.com/gofs-cli/gofs").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "</div><div class=\"m-auto px-8 pt-32 md:w-[850px]\"><h2 class=\"font-title pt-3 text-2xl\">Gofs helps you write apps that have go frontends and backends,  bringing go's <a class=\"link\" href=\"https://go.dev/doc/go1compat\">backward compatibility commitment</a> to your entire app.  Gofs apps are carefully crafted to be secure and avoid becoming part of legacy debt.</h2></div><div class=\"m-auto w-screen px-8 pt-32 md:w-[650px]\"><div class=\"font-title space-y-2\"><h2 class=\"pt-6 text-6xl font-extrabold\">Stable.</h2><h2 class=\"font-title pt-3 text-2xl\">No more upgrade cycles.  Focus your effort on new features instead of keeping up with upgrades.</h2><h2 class=\"pt-6 text-6xl font-extrabold\">Avoid Frameworks.</h2><h2 class=\"font-title pt-3 text-2xl\">Code the way you want. Avoid frameworks that impose conventions or limit your  creativity.</h2><h2 class=\"pt-6 text-6xl font-extrabold\">Few Dependencies.</h2><h2 class=\"font-title pt-3 text-2xl\">Minimize dependency related issues and security vulnerabilities.</h2></div></div><div class=\"m-auto w-screen px-8 pt-32 md:w-[850px]\"><h2 class=\"font-title pt-3 text-2xl\">Gofs apps are built on on top of these giants. They are lightweight, stable, and have no dependencies of their own. They are modern popular alternatives to  heavyweight legacy frameworks. </h2><div class=\"mt-10 flex flex-col items-center gap-10\"><a href=\"https://alpinejs.dev\"><img src=\"/assets/img/alpinejs.svg\" class=\"h-16\" aria-label=\"alpinejs\"></a> <a href=\"https://htmx.org\" class=\"font-sans text-6xl\">&lt;<b class=\"text-blue-400\">/</b>&gt; htm<b class=\"text-blue-400\">x</b></a> <a href=\"https://templ.guide\"><img src=\"/assets/img/templ.svg\" class=\"h-14\" aria-label=\"templ\"></a></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
